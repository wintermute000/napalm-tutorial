...
def main(config_file):
    ...
    # Connect:
    # device = driver(hostname='172.17.1.11', username='ansible',
    #                 password='ansible', optional_args={'port': 80})

    device = driver(hostname='veos1', username='admin',
                    password='admin', optional_args={'port': 443})
